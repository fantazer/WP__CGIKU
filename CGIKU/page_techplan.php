			...
			<div class="main-cont">
				...
				<div class="cost">
					...
					<div class="cost__el">
						...
						<div class="cost__el-text">(жилой дом)</div>
					...
					<div class="cost__el">
						...
						<div class="cost__el-text">(коттедж)</div>
						<div class="cost__el-price">25 000 руб.</div>
						<div class="service__btn service__btn-get modal-get" data-modal="order">Заказать</div>
					</div>
				</div>
				<div class="cost-inform">Указанные здесь цены являются окончательными и зависят только от площади объекта. Единственный платёж, который Вам придётся уплатить, это гос. пошлина в размере 350 руб., взимаемая Росреестром при подаче технического плана.</div>
			</div>
		</div>
